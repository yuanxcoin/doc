title: Gyuanx.network Documentation | Gyuanx and Monero Wallet RPC Guide 
 ...
 * `type - string`: The mapping type, currently we only support "session". In future "gyuanxnet" and "blockchain" mappings will be available.
 * `name - string`: The desired name to update via Gyuanx Name Service
 * `encrypted_value - string`: (Optional): The new encrypted value that the name maps to via Gyuanx Name Service. If not specified or given the empty string "", then the mapping's value remains unchanged.
 ...
 * `type - string`: The mapping type, "gyuanxnet" (1-year), or "gyuanxnet_2y", "gyuanxnet_5y", "gyuanxnet_10y" for multi-year registrations.
 ...
 * `type - string`: The mapping type, "session" or "gyuanxnet".
 * `name - string`: The name to update via Gyuanx Name Service
 * `value - string`: (Optional): The new value that the name maps to via Gyuanx Name Service. If not specified or given the empty string "", then the mapping's value remains unchanged. If using a `signature` then this value (if non-empty) must be already encrypted.
 * `owner - string`: (Optional): The new owner of the mapping. If not specified or given the empty string "", then the mapping's owner remains unchanged.
 * `backup_owner - string`: (Optional): The new backup owner of the mapping. If not specified or given the empty string "", then the mapping's backup owner remains unchanged.
...
-d @- << EOF
{
  ...
  "params": {
    "standard_address": "TODO(gyuanx): Write example string",
    "payment_id": "f378710e54eeeb8d"
  }
}
EOF
...
Example Response
{
  ...
  "id": "0",
  "result": {
    "integrated_address": "TODO(gyuanx): Write example string",
    "payment_id": "f378710e54eeeb8d"
  }
}
...
Example Response
{
  "jsonrpc": "2.0",
  "id": "0",
  "uri": "TODO(gyuanx): Write example string"
}
...
Example Response
{
  ...
  "result": {
    ...
    "unknown_parameters": ["TODO(gyuanx): Write example string"]
  }
}
...
-d @- << EOF
{
  ...
  "method": "query_key",
  "params": {
    "key_type": "TODO(gyuanx): Write example string"
  }
}
EOF
...
-d @- << EOF
{
  ...
  "params": {
    "register_service_node_str": "TODO(gyuanx): Write example string",
    "get_tx_key": true,
    "do_not_relay": true,
    "get_tx_hex": true,
    "get_tx_metadata": true
...
-d @- << EOF
{
  ...
  "method": "relay_tx",
  "params": {
    "hex": "TODO(gyuanx): Write example string",
    "blink": true
  }
}
EOF
...
-d @- << EOF
{
  ...
  "params": {
    "restore_height": 123,
    "filename": "Doyles_Cool_Wallet",
    "seed": "TODO(gyuanx): Write example string",
    "seed_offset": "TODO(gyuanx): Write example string",
    "password": "not_a_secure_password",
    "language": "english",
    "autosave_current": true
  }
...
-d @- << EOF
{
  ...
  "params": {
    "address": "L8KJf3nRQ53NTX1YLjtHryjegFRa3ZCEGLKmRxUfvkBWK19UteEacVpYqpYscSJ2q8WRuHPFdk7Q5W8pQB7Py5kvUs8vKSk",
    "proxy": "TODO(gyuanx): Write example string",
    "trusted": true,
    "ssl_private_key_path": "TODO(gyuanx): Write example string",
    "ssl_certificate_path": "TODO(gyuanx): Write example string",
    "ssl_ca_file": "TODO(gyuanx): Write example string",
...
-d @- << EOF
{
  ...
  "params": {
    "tx_data_hex": "TODO(gyuanx): Write example string"
  }
}
EOF
...
Example Response
{
  ...
  "id": "0",
  "result": {
    "signed_txset": "TODO(gyuanx): Write example string",
    "tx_hash_list": ["b605cab7e3b9fe1f6d322e3167cd26e1e61c764afa9d733233ef716787786123"],
    "tx_raw_list": ["TODO(gyuanx): Write example string"],
 ...
 * `amount - uint64`: Amount of Gyuanx to stake in atomic units.
 * `subaddr_indices - uint32[]`: (Optional) Transfer from this set of subaddresses. (Defaults to 0)
 * `service_node_key - string`: Service Node Public Address.
 * `priority - uint32`: Set a priority for the transaction. Accepted values are: or 0-4 for: default, unimportant, normal, elevated, priority.
 * `get_tx_key - bool`: (Optional) Return the transaction key after sending.
...
Example Response
{
  ...
  "result": {
    ...
    "tx_metadata_list": ["TODO(gyuanx): Write example string"],
    "multisig_txset": "TODO(gyuanx): Write example string",
    "unsigned_txset": "TODO(gyuanx): Write example string"
  }
}
 ...
 * `outputs - uint64`: 
 * `unlock_time - uint64`: Number of blocks before the gyuanx can be spent (0 to not add a lock).
 ...
 * `destinations - wallet::transfer_destination[]`: Array of destinations to receive GYUANX.
   * `address - string`: Destination public address.
   * `amount - uint64`: Amount to send to each destination, in atomic units.
 * `account_index - uint32`: (Optional) Transfer from this account index. (Defaults to 0)
 * `subaddr_indices - uint32[]`: (Optional) Transfer from this set of subaddresses. (Defaults to 0)
 * `priority - uint32`: Set a priority for the transaction. Accepted values are: 1 for unimportant or 5 for blink. (0 and 2-4 are accepted for backwards compatibility and are equivalent to 5)
 * `unlock_time - uint64`: Number of blocks before the gyuanx can be spent (0 to use the default lock time).
...
Example Response
{
  ...
  "result": {
    ...
    "subaddress": true,
    "nettype": "MAINNET",
    "openalias_address": "TODO(gyuanx): Write example string"
  }
}
 ...
 * `valid - bool`: States if it is a valid Gyuanx address.
