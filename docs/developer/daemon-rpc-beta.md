...
description: This is a list of the daemon RPC calls, their inputs and outputs, and examples of each automatically generated. This guide can be used by coins who share a codebase with Gyuanx, Oxen and Monero. 
...
## [JSON](#json)
 ...
 - [GYUANXNET\_PING](#gyuanxnet_ping)
...
-d @- << EOF
{
  ...
  "params": {
    ...
    "wallet_address": "L8KJf3nRQ53NTX1YLjtHryjegFRa3ZCEGLKmRxUfvkBWK19UteEacVpYqpYscSJ2q8WRuHPFdk7Q5W8pQB7Py5kvUs8vKSk",
    "prev_block": "bf430a3279f576ed8a814be25193e5a1ec61d3ee5729e64f47d8480ce5a2da70",
    "extra_nonce": "TODO(gyuanx): Write example string"
  }
}
EOF
 ...
 * `block_header - block_header_response`: A structure containing block header information. See get_last_block_header.
   * `major_version - uint8`: The major version of the gyuanx protocol at this block height.
   * `minor_version - uint8`: The minor version of the gyuanx protocol at this block height.
   ...
   * `nonce - uint32`: A cryptographic random one-time number used in mining a Gyuanx block.
   ...
   * `difficulty - uint64`: The strength of the Gyuanx network based on mining power.
   * `cumulative_difficulty - uint64`: The cumulative strength of the Gyuanx network based on mining power.
   * `reward - uint64`: The amount of new generated in this block and rewarded to the miner, foundation and service Nodes. Note: 1 GYUANX = 1e12 atomic units.
   * `miner_reward - uint64`: The amount of new generated in this block and rewarded to the miner. Note: 1 GYUANX = 1e12 atomic units.
...
-d @- << EOF
{
  ...
  "params": {
    "hash": "bf430a3279f576ed8a814be25193e5a1ec61d3ee5729e64f47d8480ce5a2da70",
    "hashes": ["TODO(gyuanx): Write example string"],
    "fill_pow_hash": true,
    "get_tx_hashes": true
  }
}
 ...
 * `burn_amount - uint64`: Amount of burnt gyuanx.
...
Example Response
{
  ...
  "result": {
    ...
    "last_gyuanxnet_ping": [123],
    "free_space": [123],
    "offline": true,
    "untrusted": false,
    "bootstrap_daemon_address": ["127.0.0.1:11013"],
 ...
 * `immutable_height - uint64`: The latest height in the blockchain that can not be reorganized from (backed by atleast 2 Service Node, or 1 hardcoded checkpoint, 0 if N/A).
 * `pulse_ideal_timestamp - uint64`: For pulse blocks this is the ideal timestamp of the next block, that is, the timestamp if the network was operating with perfect 2-minute blocks since the pulse hard fork.
 * `pulse_target_timestamp - uint64`: For pulse blocks this is the target timestamp of the next block, which targets 2 minutes after the previous block but will be slightly faster/slower if the previous block is behind/ahead of the ideal timestamp.
 ...
 * `last_gyuanxnet_ping - uint64[]`: Last ping time of gyuanxnet (0 if never or not running as a service node)
 ...
 * `outputs - get_outputs_out[]`: Array of structure `get_outputs_out`.
   * `amount - uint64`: Amount of Gyuanx in TXID.
   * `index - uint64`
...
Example Response
{
  ...
  "result": {
    "status": "OK",
    "distributions": [{
      "data": "TODO(gyuanx): Write example string",
      "amount": 26734261552878,
      "compressed_data": "TODO(gyuanx): Write example string",
      "binary": true,
      "compress": true
    }],
    "untrusted": false
 ...
 * `white_list - peer[]`: Array of online peer structure.
   ...
   * `port - uint16`: TCP port the peer is using to connect to gyuanx network.
 ...
 * `quorum_type - uint8`: (Optional): Set value to request a specific quorum, 0 = Obligation, 1 = Checkpointing, 2 = Blink, 3 = Pulse, 255 = all quorums, default is all quorums. For Pulse quorums, requesting the blockchain height (or latest) returns the primary pulse quorum responsible for the next block; for heights with blocks this returns the actual quorum, which may be a backup quorum if the primary quorum did not produce in time.
 ...
 * `quorums - quorum_for_height[]`: An array of quorums associated with the requested height
   ...
   * `quorum - quorum_t`: Quorum of Service Nodes
     * `validators - string[]`: List of service node public keys in the quorum. For obligations quorums these are the testing nodes; for checkpoint and blink these are the participating nodes (there are no workers); for Pulse blink quorums these are the block signers.
     * `workers - string[]`: Public key of the quorum workers. For obligations quorums these are the nodes being tested; for Pulse quorums this is the block producer. Checkpoint and Blink quorums do not populate this field.
 * `untrusted - bool`: If the result is obtained using bootstrap mode, and therefore not trusted `true`, or otherwise `false`.
...
Example Response
{
  ...
  "result": {
    "service_node_states": [{
      ...
      "service_node_version": ["TODO(gyuanx): Write example string"],
      "contributors": [{
        "amount": 26734261552878,
        "reserved": 123,
        "address": "L8KJf3nRQ53NTX1YLjtHryjegFRa3ZCEGLKmRxUfvkBWK19UteEacVpYqpYscSJ2q8WRuHPFdk7Q5W8pQB7Py5kvUs8vKSk",
      ...
      "checkpoint_participation": ["TODO(gyuanx): Write example string"],
      "pulse_participation": ["TODO(gyuanx): Write example string"]
    }],
    "height": 234767,
    "target_height": 123,
    "block_hash": "bf430a3279f576ed8a814be25193e5a1ec61d3ee5729e64f47d8480ce5a2da70",
    ...
    "hardfork": 11,
    "status": "OK",
    "as_json": "TODO(gyuanx): Write example string"
  }
}
 ...
 * `service_node_states - entry[]`: Array of service node registration information
   ...
   * `contributors - service_node_contributor[]`: Array of contributors, contributing to this Service Node.
     * `amount - uint64`: The total amount of locked Gyuanx in atomic units for this contributor.
     * `reserved - uint64`: The amount of Gyuanx in atomic units reserved by this contributor for this Service Node.
   ...
   * `total_contributed - uint64`: The total amount of Gyuanx in atomic units contributed to this Service Node.
   * `total_reserved - uint64`: The total amount of Gyuanx in atomic units reserved in this Service Node.
   ...
   * `storage_lmq_port - uint16`: The port number associated with the storage server (gyuanxmq interface)
   ...
   * `pulse_participation - service_nodes::participation_entry[]`: Of the last N pulse blocks the Service Node is in a pulse quorum, record whether or not the Service Node voted (participated) in that block
 ...
 * `blacklist - entry[]`: Array of blacklisted key images, i.e. unspendable transactions
   ...
   * `amount - uint64`: The total amount of locked Gyuanx in atomic units in this blacklisted stake.
 * `status - string`: Generic RPC error code. "OK" is the success value.
 ...
 * `contributions - contribution_t[]`: Array of contributors for this Service Node
   ...
   * `amount - uint64`: The amount that the contributor will reserve in Gyuanx atomic units towards the staking requirement
...
-d @- << EOF
{
  ...
  "params": {
    "args": ["TODO(gyuanx): Write example string"],
    "make_friendly": true,
    "staking_requirement": 100000000000
  }
}
...
Example Response
{
  ...
  "id": "0",
  "result": {
    "service_node_state": "TODO(gyuanx): Write example string",
    "height": 234767,
    "block_hash": "bf430a3279f576ed8a814be25193e5a1ec61d3ee5729e64f47d8480ce5a2da70",
    "status": "OK",
    "as_json": "TODO(gyuanx): Write example string"
 ...
 * `staking_requirement - uint64`: The staking requirement in Gyuanx, in atomic units.
...
Example Response
{
  ...
  "result": {
    ...
    "txs": [{
      ...
      "as_hex": ["TODO(gyuanx): Write example string"],
      "pruned_as_hex": ["TODO(gyuanx): Write example string"],
      "prunable_as_hex": ["TODO(gyuanx): Write example string"],
      ...
      "extra": [{
        ...
        "mm_depth": [2130706433],
        "mm_root": ["TODO(gyuanx): Write example string"],
        "additional_pubkeys": ["TODO(gyuanx): Write example string"],
        "sn_winner": ["TODO(gyuanx): Write example string"],
        "sn_pubkey": ["TODO(gyuanx): Write example string"],
        "sn_registration": [{
          "contributors": [{
            "wallet": "TODO(gyuanx): Write example string",
            "portion": 2130706433
          }],
          "fee": 2130706433,
          "expiry": 123
        }],
        "sn_contributor": ["TODO(gyuanx): Write example string"],
        "sn_state_change": [{
          "old_dereg": [true],
        ...
        "tx_secret_key": ["TODO(gyuanx): Write example string"],
        "locked_key_images": ["TODO(gyuanx): Write example string"],
        "key_image_unlock": ["TODO(gyuanx): Write example string"],
        "lns": [{
          "buy": [true],
          "update": [true],
          "renew": [true],
          "type": "TODO(gyuanx): Write example string",
          "blocks": [123],
          "name_hash": "TODO(gyuanx): Write example string",
 ...
 * `txs - entry[]`: Array of tx data
   ...
   * `extra - extra_entry[]`: Parsed tx_extra information (only if requested)
     ...
     * `burn_amount - uint64[]`: The amount of GYUANX that this transaction burns
     ...
     * `lns - lns_details[]`: an LNS registration or update
       ...
       * `type - string`: The LNS request type.  For registrations: "gyuanxnet", "session", "wallet"; for a record update: "update"
       * `blocks - uint64[]`: The registration length in blocks (only applies to gyuanxnet registrations; session/wallet registrations do not expire)
...
Example Response
{
  ...
  "result": {
    ...
    "transactions": [{
      ...
      "tx_json": "TODO(gyuanx): Write example string",
      "blob_size": 123,
      "weight": 123,
      "fee": 123,
      ...
      "blink": true,
      "extra": ["TODO(gyuanx): Write example string"]
    }],
    "spent_key_images": [{
      "id_hash": "bf430a3279f576ed8a814be25193e5a1ec61d3ee5729e64f47d8480ce5a2da70",
      "txs_hashes": ["b605cab7e3b9fe1f6d322e3167cd26e1e61c764afa9d733233ef716787786123"]
 ...
 * `backlog - tx_backlog_entry[]`: Array of structures tx_backlog_entry (in binary form):
   * `weight - uint64`: 
   * `fee - uint64`: Fee in Gyuanx measured in atomic units.
   * `time_in_pool - uint64`
 * `untrusted - bool`: States if the result is obtained using the bootstrap mode, and is therefore not trusted (`true`), or when the daemon is fully synced (`false`).
 ...
 * `entries - request_entry[]`: Entries to look up
   * `name_hash - string`: The 32-byte BLAKE2b hash of the name to resolve to a public key via Gyuanx Name Service. The value must be provided either in hex (64 hex digits) or base64 (44 characters with padding, or 43 characters without).
   * `types - uint16[]`: If empty, query all types. Currently supported types are 0 (session) and 2 (gyuanxnet). In future updates more mapping types will be available.
 ...
 * `entries - response_entry[]`
   * `entry_index - uint64`: The index in request_entry's `entries` array that was resolved via Gyuanx Name Service.
   * `type - lns::mapping_type`: The type of Gyuanx Name Service entry that the owner owns: currently supported values are 0 (session), 2 (gyuanxnet)
   ...
   * `backup_owner - string[]`: The backup public key that the owner specified when purchasing the Gyuanx Name Service entry. Omitted if no backup owner.
   ...
   * `update_height - uint64`: The last height that this Gyuanx Name Service entry was updated on the Blockchain.
 ...
 * `entries - string[]`: The owner's public key to find all Gyuanx Name Service entries for.
 * `include_expired - bool`: Optional: if provided and true, include entries in the results even if they are expired

**Outputs:**

 * `entries - response_entry[]`
   * `request_index - uint64`: (Deprecated) The index in request's `entries` array that was resolved via Gyuanx Name Service.
   * `type - lns::mapping_type`: The category the Gyuanx Name Service entry belongs to; currently 0 for Session and 2 for Gyuanxnet.
   * `name_hash - string`: The hash of the name that the owner purchased via Gyuanx Name Service in base64
   * `owner - string`: The backup public key specified by the owner that purchased the Gyuanx Name Service entry.
   * `backup_owner - string[]`: The backup public key specified by the owner that purchased the Gyuanx Name Service entry. Omitted if no backup owner.
...
Example Response
{
  ...
  "result": {
    ...
    "nonce": ["TODO(gyuanx): Write example string"]
  }
}
 ...
 * `type - uint16`: The LNS type (mandatory); currently supported values are: 0 = session, 2 = gyuanxnet.
...
-d @- << EOF
{
  "jsonrpc": "2.0",
  "id": "0",
  "method": "gyuanxnet_ping",
  "params": {
    "version": ["TODO(gyuanx): Write example string"]
  }
}
EOF
 ...
 * `version - int[3]`: Gyuanxnet version
...
Example Response
{
  ...
  "result": {
    ...
    "threads_count": 8,
    "address": "L8KJf3nRQ53NTX1YLjtHryjegFRa3ZCEGLKmRxUfvkBWK19UteEacVpYqpYscSJ2q8WRuHPFdk7Q5W8pQB7Py5kvUs8vKSk",
    "pow_algorithm": "RandomX (GYUANX variant)",
...
-d @- << EOF
{
  ...
  "params": {
    "tx_as_hex": "TODO(gyuanx): Write example string",
    "do_not_relay": true,
...
Example Response
{
  ...
  "result": {
    "status": "OK",
    "reason": "TODO(gyuanx): Write example string",
    "not_relayed": true,
    "untrusted": false,
    "tvc": {
      ...
      "m_verbose_error": "TODO(gyuanx): Write example string",
      "m_vote_ctx": {
    ...
    "blink_status": "TODO(gyuanx): Write example string"
  }
}
...
-d @- << EOF
{
  ...
  "params": {
    "address": "L8KJf3nRQ53NTX1YLjtHryjegFRa3ZCEGLKmRxUfvkBWK19UteEacVpYqpYscSJ2q8WRuHPFdk7Q5W8pQB7Py5kvUs8vKSk",
    "username": "TODO(gyuanx): Write example string",
...
-d @- << EOF
{
  ...
  "params": {
    "categories": "TODO(gyuanx): Write example string"
  }
}
EOF
...
-d @- << EOF
{
  ...
  "method": "submit_block",
  "params": {
    "blob": ["TODO(gyuanx): Write example string"]
  }
}
EOF
...
Example Response
{
  ...
  "result": {
    ...
    "spans": [{
      ...
      "speed": 2130706433,
      "size": 123,
      "remote_address": "127.0.0.1:11013"
    }],
    "overview": "TODO(gyuanx): Write example string"
  }
}
